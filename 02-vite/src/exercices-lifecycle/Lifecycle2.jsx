...
function Lifecycle2() {
    ...
    const previousDegree = useRef(0); // La ref c'est un state qui ne déclenche pas de mise à jour du DOM
    ...
    useEffect(() => {
        console.log(previousDegree.current);
        ...
        return () => {
            previousDegree.current = degrees; // Mets à jour la valeur précédente dans la ref
            console.log(previousDegree.current);
        };
    }, [degrees]);
